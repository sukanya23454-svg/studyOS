...
export const ENVIRONMENTS: StudyEnvironment[] = [
  {
    ...
    image: envRainyCafe,
    gradient: 'linear-gradient(135deg, #2d1b0e 0%, #4a2c17 40%, #1a1a2e 100%)',
    animation: 'rain',
  },
  {
    id: 'cozy-library',
    ...
    gradient: 'linear-gradient(135deg, #1c1410 0%, #3d2b1f 50%, #1a1408 100%)',
    animation: 'dust',
  },
  {
    id: 'night-city',
    name: 'Night City Desk',
    emoji: '🌃',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #0d1a0d 0%, #1a2e1a 50%, #0a140a 100%)',
    animation: 'leaves',
  },
  {
    id: 'rainy-bedroom',
