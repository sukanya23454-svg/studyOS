      ...
      >
        ...
        <div className="rounded-2xl border p-7 backdrop-blur-xl"
          style={{
            ...
            boxShadow: '0 8px 40px hsla(0,0%,0%,0.5), 0 0 60px hsla(38,80%,50%,0.05)',
          }}
        >
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-display text-lg font-bold text-foreground">Create Account</span>
          </div>

          <button
            onClick={handleGoogleSignup}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-medium transition-all hover:bg-secondary/50"
            style={{ borderColor: 'hsla(215,20%,40%,0.2)', color: 'hsl(210,20%,85%)' }}
          >
          ...
          <form onSubmit={handleSignup} className="space-y-3">
            <div className="relative">
              ...
              <Input placeholder="Display name (optional)" value={name} onChange={e => setName(e.target.value)} className="pl-10 bg-secondary/50 border-border" />
            </div>
            <div className="relative">
